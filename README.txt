...
**feature1, feature2 and feature3** (case sensitive) - These branches are to be created and used once you get to Exercise 2.
...
## Important note about GitHub Teams Discussion feature

Almost all GitHub Classroom based assessments in this course require team discussions to be entered using GitHub Discussions feature. As we note, GitHub will be dumping this feature from May 8th, 2023. On your GitHub team page (once you have created a GitHub assignment team), you will see an option to transfer your Discussions feature to your repo page. You are expected to do it for all your assessments. You can also use the Issues feature in your repo to carry out discussions, if you like. Whatever you decide to do, you must clearly mention it in your <tt>Team.md</tt> file. The purpose of this file is explained at different places in this document.
...
The marking of this lab will be based on your team repository as of **Friday 17
...
**You must form a team and enter your initial team communication via GitHub Discussions before Thursday, 9 Mar 17:00hrs NZ time**. Some examples of this evidence could be: who does what, by when you plan to finish the exercises, constraints, planning notes, etc. Additionally, feel free to use GitHub Issues to report and discuss specific issues that you face while working on the exercises. If you end up using both Discussions and Issues, clearly state this in Team.md. If you fail to add any notes to Discussions before the Initial Team Communication deadline, **25% penalty** will be applied to the lab marks.
